...
/***/ function(module, exports, __webpack_require__) {
	...
	var _icsJs = __webpack_require__(2);
	
	var _icsJs2 = _interopRequireDefault(_icsJs);
	
	var _shift = __webpack_require__(6);
	...
	var App = (function () {
	  ...
	  _createClass(App, [{
	    key: 'createEventFromElement',
	    value: function createEventFromElement(element) {
	      var dayOfWeek = $(element).children('td.day:first').text().trim();
	      var startTime = $(element).children('td.time:first').text().trim();
	      var endTime = $(element).children('td.time:nth-child(5)').text().trim();
	
	      var shift = new _shift2['default'](this.baseDate, dayOfWeek, startTime, endTime);
	
	      var event = new _icsJs2['default'].Event();
	    ...
	    value: function execute() {
	      ...
	      var scheduleContainer = $('#pane1 > table:nth-child(2) > tbody > tr:first > td:nth-child(2)');
	      var header = scheduleContainer.find('table:first > tbody > tr:nth-child(2) > td:first');
	      var shifts = scheduleContainer.find('table:nth-child(2) > tbody > tr:not(.disable)');
	
	      this.baseDate = header.text().slice(15).trim();
	
	      shifts.each(function (_, element) {
	        return _this.createEventFromElement(element);
	      });
	
	      this.ics.toBase64(function (result) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _icsEvent = __webpack_require__(3);
	
	var _icsEvent2 = _interopRequireDefault(_icsEvent);
	
	var _errorsNoEventsError = __webpack_require__(5);
	
	var _errorsNoEventsError2 = _interopRequireDefault(_errorsNoEventsError);
	
	var _errorsInvalidEventError = __webpack_require__(4);
	...
	var Shift = (function () {
	  _createClass(Shift, null, [{
	    ...
	    value: function value() {
	      var weekdays = _moment2["default"].weekdays();
	  ...
	  function Shift(date, dayOfWeek, startTime, endTime) {
	    _classCallCheck(this, Shift);
	
	    var start = (0, _moment2["default"])(date + " " + startTime, Shift.momentFormat);
	    start.add(Shift.weekdays().indexOf(dayOfWeek), "days");
	
	    var end = (0, _moment2["default"])(date + " " + endTime, Shift.momentFormat);
...
/***/ }
/******/ ]);
//# sourceMappingURL=mypage-to-ics.js.map